...
public class RobotMovesWithTeleportThatHasPlacedPair implements UseCase{
    Robot r;
    Teleport dest;
    Teleport t2;
    Asteroid a;
    ...
    public void init(){
        ...
        Logger.pushToRegisterNameStack("r","a","dest","t2","a2");
    ...
    {
        return "Robot Moves With Teleport That Has Placed Pair";
    }
}
